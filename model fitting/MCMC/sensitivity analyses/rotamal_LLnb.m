function [logLL,H]=rotamal_LLnb(St,p,data,data2,negtest,negtest2,time)
% This function is called from "rotamalawi_mcmc1nb". It calculates the
...
% The log-likelihood is calculated assuming the number of cases in each age
% group and week follows a negative-binomial distribution 
...
ar2=p(6);
h=p(7);
nbr=p(8); %shape parameter for negative binomial distribution
