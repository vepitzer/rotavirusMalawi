function [LL,D,D2]=rotafitM1nb(unkp,data,data2,malpop,Bmal,varargin)
...
% Assumes the data follows a negative-binomial distribution.
...
[time St]=ode45(@rasisM1,1:tmax,St0,options,pars); %solve differential equations defined in 'rasisAW'
