function [LL,Dv]=rotafitMV1(unkp,pars,dataV,dataU,malpop,Bmal,repeffV,vcov,varargin)
% This is for the base-case model assuming homogeneity in vaccine response. 
