...
sc1=.528; %probability of responding to first dose
sc2=.895; %probability of responding to second dose given responded to first dose
sc3=.895; %probability of responding to third dose given responded to second dose
...
OEtot_nr(relinf,1)=1-sum(sum(H(tvacc+1:tvf-t0,1:au5)))/sum(sum(Hnovacc(tvacc+1:tvf-t0,1:au5)));
OEage_nr(relinf,:)=1-[sum(sum(H(tvacc+1:tvf-t0,1:12)))/sum(sum(Hnovacc(tvacc+1:tvf-t0,1:12)))...
...
%%
Hyr_novacc_nr=zeros(11,4);
Hyr_nobooster_nr=zeros(11,4);
Hyr_booster_nr=zeros(11,4);
for y=1:11
    for j=1:length(rotamalPV)
        if malPVdate(j,1)==2011+y
            Hyr_novacc_nr(y,:)=Hyr_novacc_nr(y,:)+[sum(Hnovacc(tvacc+j,1:12)) sum(Hnovacc(tvacc+j,13:au2)) sum(Hnovacc(tvacc+j,au2+1:au5)) sum(Hnovacc(tvacc+j,1:au5))];
            if targ==3
                Hyr_nobooster_nr(y,:)=Hyr_nobooster_nr(y,:)+[Hrelinf0_nobooster_nr(tvacc+j,1) Hrelinf1_nobooster_nr(tvacc+j,1) Hrelinf2_nobooster_nr(tvacc+j,1) sum(H(tvacc+j,1:au5),2)];
            elseif targ==4
                Hyr_booster_nr(y,:)=Hyr_booster_nr(y,:)+[Hrelinf0_booster_nr(tvacc+j,1) Hrelinf1_booster_nr(tvacc+j,1) Hrelinf2_booster_nr(tvacc+j,1) sum(H(tvacc+j,1:au5),2)];
            end
        end
    end
end
   
OEyr_nr=1-Hyr_nobooster_nr./Hyr_novacc_nr;
...
for yr=1:9
    ...
    VEtot_byyr(yr,2)=1-((sum(Hv(tvacc+52*yr+1:tvacc+52*(yr+1),4:au5))./sum(V(tvacc+52*yr+1:tvacc+52*(yr+1),4:au5)))*agedistV_byyr(yr,4:au5)')/((sum(Hu(tvacc+52*yr+1:tvacc+52*(yr+1),4:au5))./sum(U(tvacc+52*yr+1:tvacc+52*(yr+1),4:au5)))*agedistU_byyr(yr,4:au5)');
    IEtot_byyr(yr,2)=sum((1-(sum(Hu(tvacc+52*yr+1:tvacc+52*(yr+1),1:au5).*Hu(tvacc+52*yr+1:tvacc+52*(yr+1),1:au5)./U(tvacc+52*yr+1:tvacc+52*(yr+1),1:au5),2)./sum(Hu(tvacc+52*yr+1:tvacc+52*(yr+1),1:au5),2))./(sum(Hnovacc(tvacc+52*yr+1:tvacc+52*(yr+1),1:au5).*Hnovacc(tvacc+52*yr+1:tvacc+52*(yr+1),1:au5)./Unovacc(tvacc+52*yr+1:tvacc+52*(yr+1),1:au5),2)./sum(Hnovacc(tvacc+52*yr+1:tvacc+52*(yr+1),1:au5),2))).*sum(Hu(tvacc+52*yr+1:tvacc+52*(yr+1),1:au5),2))/sum(sum(Hu(tvacc+52*yr+1:tvacc+52*(yr+1),1:au5),2));
    
    VEage_mal2_byyr(yr,:)=1-[(sum(sum(Hv(tvacc+52*yr+1:tvacc+52*(yr+1),4:12),2))/sum(sum(V(tvacc+52*yr+1:tvacc+52*(yr+1),4:12),2)))/(sum(sum(Hu(tvacc+52*yr+1:tvacc+52*(yr+1),4:12),2))/sum(sum(U(tvacc+52*yr+1:tvacc+52*(yr+1),4:12),2)))...
    ...
    IEage_mal2_byyr(yr,:)=1-[(sum(sum(Hu(tvacc+52*yr+1:tvacc+52*(yr+1),1:12),2))/sum(sum(U(tvacc+52*yr+1:tvacc+52*(yr+1),1:12),2)))/(sum(sum(Hnovacc(tvacc+52*yr+1:tvacc+52*(yr+1),1:12),2))/sum(sum(Unovacc(tvacc+52*yr+1:tvacc+52*(yr+1),1:12),2)))...
