...
if targ==1
Hdirect0_wane_nobooster(:,relinf)=sum(Hdirect(:,1:12),2);
Hdirect1_wane_nobooster(:,relinf)=sum(Hdirect(:,13:au2),2);
Hdirect2_wane_nobooster(:,relinf)=sum(Hdirect(:,au2+1:au5),2);
elseif targ==2
Hdirect0_wane_booster(:,relinf)=sum(Hdirect(:,1:12),2);
Hdirect1_wane_booster(:,relinf)=sum(Hdirect(:,13:au2),2);
Hdirect2_wane_booster(:,relinf)=sum(Hdirect(:,au2+1:au5),2);
end
...
VEtot_wane_direct(relinf,1)=1-((sum(Hv_direct(tvacc+52:tvacc+233,4:au5))./sum(V(tvacc+52:tvacc+233,4:au5)))*agedistV(4:au5)')/((sum(Hu_direct(tvacc+52:tvacc+233,4:au5))./sum(U(tvacc+52:tvacc+233,4:au5)))*agedistU(4:au5)');
VEage_wane_direct(relinf,:)=1-[(sum(sum(Hv_direct(tvacc+52:tvacc+233,4:12),2))/sum(sum(V(tvacc+52:tvacc+233,4:12),2)))/(sum(sum(Hu_direct(tvacc+52:tvacc+233,4:12),2))/sum(sum(U(tvacc+52:tvacc+233,4:12),2)))...
...
for y=1:10
    if targ==1
        Hyr_wane_direct(y,:)=[sum(sum(H(tvacc+round(52.18*(y-1))+6:tvacc+round(52.18*(y-1))+57,1:4))) sum(sum(H(tvacc+round(52.18*(y-1))+6:tvacc+round(52.18*(y-1))+57,5:12))) sum(sum(H(tvacc+round(52.18*(y-1))+6:tvacc+round(52.18*(y-1))+57,13:au2))) sum(sum(H(tvacc+round(52.18*(y-1))+6:tvacc+round(52.18*(y-1))+57,au2+1:au5)))];
    elseif targ==2
        Hyr_waneboost_direct(y,:)=[sum(sum(H(tvacc+round(52.18*(y-1))+6:tvacc+round(52.18*(y-1))+57,1:4))) sum(sum(H(tvacc+round(52.18*(y-1))+6:tvacc+round(52.18*(y-1))+57,5:12))) sum(sum(H(tvacc+round(52.18*(y-1))+6:tvacc+round(52.18*(y-1))+57,13:au2))) sum(sum(H(tvacc+round(52.18*(y-1))+6:tvacc+round(52.18*(y-1))+57,au2+1:au5)))];
    end
end
...
plot(datesim(tvacc:tvacc+233),[Hdirect0_wane_nobooster(tvacc:tvacc+233,relinf) Hdirect1_wane_nobooster(tvacc:tvacc+233,relinf) Hdirect2_wane_nobooster(tvacc:tvacc+233,relinf)],'LineWidth',1.5)
datetick('x','mmm-yy')
