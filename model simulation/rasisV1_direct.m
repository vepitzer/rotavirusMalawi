function dSt=rasisV1_direct(t,St)
%Differential equations for the base-case model assuming vaccination ONLY
%confers direct protection (i.e. no reduction in transmission)
