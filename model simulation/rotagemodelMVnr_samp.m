% Simulates base-case rotavirus model assuming heterogeneity in vaccine response
...
load('malawi_mcmc_outputV_nr.mat')
...
sc1=betarnd(19,17); %probability of responding to first dose 
sc2=betarnd(32.2,3.8); %probability of responding to second dose given responded to first dose
sc3=betarnd(32.2,3.8); %probability of responding to third dose given responded to first dose
...
if targ==1
Hsamp0_nfnr(:,samp)=sum(H(:,1:12),2);
Hsamp1_nfnr(:,samp)=sum(H(:,13:au2),2);
Hsamp2_nfnr(:,samp)=sum(H(:,au2+1:au5),2);
elseif targ==2
Hsamp0_boost_nfnr(:,samp)=sum(H(:,1:12),2);
Hsamp1_boost_nfnr(:,samp)=sum(H(:,13:au2),2);
Hsamp2_boost_nfnr(:,samp)=sum(H(:,au2+1:au5),2);
end

%Calculate and store number of cases per year in each age group for each simulation
for y=1:10
if targ==1
Hsamp0yr_nfnr(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,1:4)));
Hsamp1yr_nfnr(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,5:12)));
Hsamp2yr_nfnr(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,13:au2)));
Hsamp3yr_nfnr(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,au2+1:au5)));
elseif targ==2
Hsamp0yr_boost_nfnr(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,1:4)));
Hsamp1yr_boost_nfnr(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,5:12)));
Hsamp2yr_boost_nfnr(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,13:au2)));
Hsamp3yr_boost_nfnr(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,au2+1:au5)));
end
end
end
...
VEtot_samp_nfnr(samp,1)=1-((sum(Hv(tvacc+52:tvf-t0,4:au5))./sum(V(tvacc+52:tvf-t0,4:au5)))*agedistV(4:au5)')/((sum(Hu(tvacc+52:tvf-t0,4:au5))./sum(U(tvacc+52:tvf-t0,4:au5)))*agedistU(4:au5)');
VEage_samp_nfnr(samp,:)=1-[(sum(sum(Hv(tvacc+52:tvf-t0,4:12),2))/sum(sum(V(tvacc+52:tvf-t0,4:12),2)))/(sum(sum(Hu(tvacc+52:tvf-t0,4:12),2))/sum(sum(U(tvacc+52:tvf-t0,4:12),2)))...
...
IEtot_samp_nfnr(samp,1)=sum((1-(sum(Hu(tvacc+52:tvf-t0,1:au5).*Hu(tvacc+52:tvf-t0,1:au5)./U(tvacc+52:tvf-t0,1:au5),2)./sum(Hu(tvacc+52:tvf-t0,1:au5),2))./(sum(Hnovacc(tvacc+52:tvf-t0,1:au5).*Hnovacc(tvacc+52:tvf-t0,1:au5)./Unovacc(tvacc+52:tvf-t0,1:au5),2)./sum(Hnovacc(tvacc+52:tvf-t0,1:au5),2))).*sum(Hu(tvacc+52:tvf-t0,1:au5),2))/sum(sum(Hu(tvacc+52:tvf-t0,1:au5),2));
IEage_samp_nfnr(samp,:)=1-[(sum(sum(Hu(tvacc+52:tvf-t0,1:12),2))/sum(sum(U(tvacc+52:tvf-t0,1:12),2)))/(sum(sum(Hnovacc(tvacc+52:tvf-t0,1:12),2))/sum(sum(Unovacc(tvacc+52:tvf-t0,1:12),2)))...
...
VEtot_boostsamp_nfnr(samp,1)=1-((sum(Hv(tvacc+315:tvacc+419,4:au5))./sum(V(tvacc+315:tvacc+419,4:au5)))*agedistV(4:au5)')/((sum(Hu(tvacc+315:tvacc+419,4:au5))./sum(U(tvacc+315:tvacc+419,4:au5)))*agedistU(4:au5)');
VEage_boostsamp_nfnr(samp,:)=1-[(sum(sum(Hv(tvacc+315:tvacc+419,4:12),2))/sum(sum(V(tvacc+315:tvacc+419,4:12),2)))/(sum(sum(Hu(tvacc+315:tvacc+419,4:12),2))/sum(sum(U(tvacc+315:tvacc+419,4:12),2)))...
...
save('malawi_vsamp_output_nfnr.mat','Hsamp0_nfnr','Hsamp1_nfnr','Hsamp2_nfnr','Hsamp0_boost_nfnr','Hsamp1_boost_nfnr','Hsamp2_boost_nfnr',...
    'Hsamp0yr_nfnr','Hsamp1yr_nfnr','Hsamp2yr_nfnr','Hsamp3yr_nfnr','Hsamp0yr_boost_nfnr','Hsamp1yr_boost_nfnr','Hsamp2yr_boost_nfnr','Hsamp3yr_boost_nfnr',...
    'VEtot_samp_nfnr','VEage_samp_nfnr','IEtot_samp_nfnr','IEage_samp_nfnr','VEtot_boostsamp_nfnr','VEage_boostsamp_nfnr')
