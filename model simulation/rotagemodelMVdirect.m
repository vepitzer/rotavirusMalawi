...
Hyr_nobooster_direct=zeros(10,4);
Hyr_booster_direct=zeros(10,4);
for y=1:10
    if targ==1
...
plot(malweeknum,sum(rotamalIP+rotamalOP,2),'b')
...
plot(datenum(malVS2date),[sum(rotamalVS2(:,1:12),2) sum(rotamalVS2(:,13:24),2) sum(rotamalVS2(:,25:end),2)]); 
