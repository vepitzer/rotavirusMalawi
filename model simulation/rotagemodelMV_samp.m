...
load('malawi_mcmc_outputV_bc.mat')
...
sc1=betarnd(24.7,11.3); %probability of responding to first dose
sc2=betarnd(24.7,11.3); %probability of responding to second dose given responded to first dose
sc3=betarnd(24.7,11.3); %probability of responding to third dose given responded to first dose
%sc1=keep_pars_V_bc(10*samp-5000*floor((samp-.5)/500),1,ceil((samp-.5)/500)); 
%sc2=keep_pars_V_bc(10*samp-5000*floor((samp-.5)/500),2,ceil((samp-.5)/500)); 
%sc3=keep_pars_V_bc(10*samp-5000*floor((samp-.5)/500),2,ceil((samp-.5)/500)); 
...
if targ==1
Hsamp0_nofit(:,samp)=sum(H(:,1:12),2);
Hsamp1_nofit(:,samp)=sum(H(:,13:au2),2);
Hsamp2_nofit(:,samp)=sum(H(:,au2+1:au5),2);
elseif targ==2
Hsamp0_boost_nofit(:,samp)=sum(H(:,1:12),2);
Hsamp1_boost_nofit(:,samp)=sum(H(:,13:au2),2);
Hsamp2_boost_nofit(:,samp)=sum(H(:,au2+1:au5),2);
end

%Calculate and store number of cases per year in each age group for each simulation
for y=1:10
Hsamp0yr_prevacc(samp,y)=sum(sum(H(1+round(52.18*(y-1)):round(52.18*(y-1))+51,1:4)));
Hsamp1yr_prevacc(samp,y)=sum(sum(H(1+round(52.18*(y-1)):round(52.18*(y-1))+51,5:12)));
Hsamp2yr_prevacc(samp,y)=sum(sum(H(1+round(52.18*(y-1)):round(52.18*(y-1))+51,13:au2)));
Hsamp3yr_prevacc(samp,y)=sum(sum(H(1+round(52.18*(y-1)):round(52.18*(y-1))+51,au2+1:au5)));
if targ==1
Hsamp0yr_nofit(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,1:4)));
Hsamp1yr_nofit(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,5:12)));
Hsamp2yr_nofit(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,13:au2)));
Hsamp3yr_nofit(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,au2+1:au5)));
elseif targ==2
Hsamp0yr_boost_nofit(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,1:4)));
Hsamp1yr_boost_nofit(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,5:12)));
Hsamp2yr_boost_nofit(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,13:au2)));
Hsamp3yr_boost_nofit(samp,y)=sum(sum(H(tvacc+round(52.18*(y-1)):tvacc+round(52.18*(y-1))+51,au2+1:au5)));
end
end
end
...
VEtot_samp_nofit(samp,1)=1-((sum(Hv(tvacc+52:tvf-t0,4:au5))./sum(V(tvacc+52:tvf-t0,4:au5)))*agedistV(4:au5)')/((sum(Hu(tvacc+52:tvf-t0,4:au5))./sum(U(tvacc+52:tvf-t0,4:au5)))*agedistU(4:au5)');
VEage_samp_nofit(samp,:)=1-[(sum(sum(Hv(tvacc+52:tvf-t0,4:12),2))/sum(sum(V(tvacc+52:tvf-t0,4:12),2)))/(sum(sum(Hu(tvacc+52:tvf-t0,4:12),2))/sum(sum(U(tvacc+52:tvf-t0,4:12),2)))...
...
IEtot_samp_nofit(samp,1)=sum((1-(sum(Hu(tvacc+52:tvf-t0,1:au5).*Hu(tvacc+52:tvf-t0,1:au5)./U(tvacc+52:tvf-t0,1:au5),2)./sum(Hu(tvacc+52:tvf-t0,1:au5),2))./(sum(Hnovacc(tvacc+52:tvf-t0,1:au5).*Hnovacc(tvacc+52:tvf-t0,1:au5)./Unovacc(tvacc+52:tvf-t0,1:au5),2)./sum(Hnovacc(tvacc+52:tvf-t0,1:au5),2))).*sum(Hu(tvacc+52:tvf-t0,1:au5),2))/sum(sum(Hu(tvacc+52:tvf-t0,1:au5),2));
IEage_samp_nofit(samp,:)=1-[(sum(sum(Hu(tvacc+52:tvf-t0,1:12),2))/sum(sum(U(tvacc+52:tvf-t0,1:12),2)))/(sum(sum(Hnovacc(tvacc+52:tvf-t0,1:12),2))/sum(sum(Unovacc(tvacc+52:tvf-t0,1:12),2)))...
...
VEtot_boostsamp_nofit(samp,1)=1-((sum(Hv(tvacc+315:tvacc+419,4:au5))./sum(V(tvacc+315:tvacc+419,4:au5)))*agedistV(4:au5)')/((sum(Hu(tvacc+315:tvacc+419,4:au5))./sum(U(tvacc+315:tvacc+419,4:au5)))*agedistU(4:au5)');
VEage_boostsamp_nofit(samp,:)=1-[(sum(sum(Hv(tvacc+315:tvacc+419,4:12),2))/sum(sum(V(tvacc+315:tvacc+419,4:12),2)))/(sum(sum(Hu(tvacc+315:tvacc+419,4:12),2))/sum(sum(U(tvacc+315:tvacc+419,4:12),2)))...
...
save('malawi_vsamp_output_nofit.mat','Hsamp0_nofit','Hsamp1_nofit','Hsamp2_nofit','Hsamp0_boost_nofit','Hsamp1_boost_nofit','Hsamp2_boost_nofit',...
    'Hsamp0yr_prevacc','Hsamp1yr_prevacc','Hsamp2yr_prevacc','Hsamp3yr_prevacc',...
    'Hsamp0yr_nofit','Hsamp1yr_nofit','Hsamp2yr_nofit','Hsamp3yr_nofit','Hsamp0yr_boost_nofit','Hsamp1yr_boost_nofit','Hsamp2yr_boost_nofit','Hsamp3yr_boost_nofit',...
    'VEtot_samp_nofit','VEage_samp_nofit','IEtot_samp_nofit','IEage_samp_nofit','VEtot_boostsamp_nofit','VEage_boostsamp_nofit')
